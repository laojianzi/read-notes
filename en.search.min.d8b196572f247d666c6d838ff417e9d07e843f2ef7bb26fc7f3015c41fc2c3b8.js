...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/read-notes/flexsearch.min.js');loadScript('/read-notes/en.search-data.min.1dce3fad1331b920338a2be687a9da76afd44c0579dc10e7b240d04b8fa82b0e.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/read-notes/flexsearch.min.js');loadScript('/read-notes/en.search-data.min.560ee66e79e76b2e6e5445fbc93c7946de9166d3360c2bbc264b75fd95e41fb5.js',function(){input.required=false;search();});}
